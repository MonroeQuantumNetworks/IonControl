...
class FileComboWidget(Base, Form):
    ...
    def __init__(self, parent=None):
        ...
        self._defaultDir = "C:\\" #used in file dialog for opening and saving files
    ...
    def recentFiles(self, filenames):
        ...
        filenames = [s for s in filenames if type(s)==str]
    ...
    def onOpen(self):
        ...
        filename = str(QtGui.QFileDialog.getOpenFileName(self, 'Open File', self.defaultDir, self.fileType))
        if filename:
    ...
    def onNew(self):
        ...
        filename = str(QtGui.QFileDialog.getSaveFileName(self, 'New File Name', self.defaultDir, self.fileType))
        if filename:
    ...
    def getFilename(self, ind):
        return str( self.filenameComboBox.itemData(ind).toString() )
