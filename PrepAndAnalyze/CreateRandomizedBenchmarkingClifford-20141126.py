...
Cliffords = [['I'], ['x', 'x', 'x', 'y'], ['x', 'x', 'x'], ['x', 'x', 'y', 'x'], ['x', 'x', 'y', 'y'], ['x', 'x', 'y'], ['x', 'x'], ['x', 'y', 'x', 'x'], ['x', 'y', 'x'], 
...
filename = "Randomized-Clifford-2014-11-26.xml"
path = ""
...
if __name__=="__main__":    
    ...
    for length in SequenceLengths:
        for randindex in range(randomizations(length)): 
            ...
            gateSequence( root, state.sequence, "{0}".format(index), index, state.state)
