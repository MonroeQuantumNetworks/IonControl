...
##        self.PCon.set_setprog('C:\AQUARIUS\prog\APDcounts.pp') # Load and sets teh .pp file at the given location
        self.PCon = DDS_GUI_Sandia_AQC.DDS_gui()
        ...
        self.PCon.pp_setprog('C:/aaContFPGA/prog/APDcounts.pp')#DarkHist  Detect DarkHist
        ...
        window = gtk.Window()
        window.set_title("Pulse contnroller")
