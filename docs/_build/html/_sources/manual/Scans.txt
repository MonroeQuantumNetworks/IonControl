...
- Evaluations table
   ...
   - ID/channel
      Specifies which counter channel to plot. The ID is the same ID specified in the pulse program counters dock.
      .. TODO: can we just make the channel number a drop down that lists the same names as in the pulse program counters dock?
