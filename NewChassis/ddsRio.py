...
class ddsRioAD9959DDS(ddsParent):
    ...
    def _setActiveChannel(self, activeChannel):
        ...
        regData = (activeChannel << 4) | regData
...
if __name__ == '__main__':
    ...
    raw_input('Press return to run single mode.')
    ddsRio.SingleTone(100e3, 0x250)
    ddsRio.PrintAll()

    raw_input('Press return to run FSK mode.')
    ddsRio.FSK(200e3, 300e3, 0x250)
    ddsRio.PrintAll()
    raw_input('Press return to run Ramped FSK mode.')
    ddsRio.RampedFSK(200e3, 300e3, 100e-3, 1e3, 0x250)
    ddsRio.PrintAll()
    raw_input('Press return to run BPSK mode.')
