...
class Settings(object):
    def __init__(self):
        # self.exposureTime = Q(20, 'ms')
        # self.EMGain = 0
        # self.NumberOfExperiments = 200
        self.exposureTime = Parameter(name = 'Exposure time', dataType = 'magnitude', value = Q(5, 'ms'),
                                      tooltip = "Exposure time")
        self.EMGain = Parameter(name = 'EMGain', dataType = 'magnitude', value = 0, tooltip = "EM gain")
        self.NumberOfExperiments = Parameter(name = 'experiments', dataType = 'magnitude', value = 133,
                                             tooltip = "Number of experiments")
        self.NumberOfIons = Parameter(name = 'ionNumber', dataType = 'magnitude', value = 1,
                                             tooltip = "Number of ions")
