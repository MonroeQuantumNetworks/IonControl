...
Exp: NOP
	...
	DACUP	# DDSPHS		DDS_ch_uWave, PH_zero
	
	SHUTRVAR 	SHUTR_Ramsey_uWave		#=408 for microwave with dipole and 1038 on
	DELAY	 	us_Time_Ramsey_half_pi		
    	SHUTRVAR 	SHUTR_exp
	DELAY	 	us_Time_exp			#DDSFRQ	 DDS_ch_MOT, F_MOT_exp
	DDSPHS		DDS_ch_uWave, PH_Ramsey_uWave
	SHUTRVAR 	SHUTR_Ramsey_uWave
	DELAY	 	us_Time_Ramsey_half_pi
