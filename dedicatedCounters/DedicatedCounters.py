...
class DedicatedCounters(DedicatedCountersForm,DedicatedCountersBase ):
    ...
    def __init__(self,config,pulserHardware,globalVariablesUi,parent=None):
...
#            AnalogInputCalibration.AnalogInputCalibration() ]
    ...
    def setupUi(self, parent):
        ...
        # AutoLoad
        self.autoLoad = AutoLoad.AutoLoad(self.config, self.pulserHardware, self.dataAvailable, self.globalVariablesUi)
